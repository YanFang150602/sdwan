            ...
            <a-col :span="24">
              <a-form-model-item>
                <a-form-model-item label="Name" prop="name">
                  <a-input v-model="URLCategoriesEdit.name"/>
                </a-form-model-item>
              </a-form-model-item>
            </a-col>
          </a-row>
            ...
            <a-col :span="24">
              <a-form-model-item>
                <a-form-model-item label="Description">
                  <a-input v-model="URLCategoriesEdit.description"/>
                </a-form-model-item>
              </a-form-model-item>
            </a-col>
          </a-row>
            ...
            <a-col :span="10">
              <a-form-model-item>
                <a-form-model-item label="Confidence" prop="value">
                  <a-input v-model="URLCategoriesEdit.confidence"/>
                </a-form-model-item>
              </a-form-model-item>
            </a-col>
            <a-col :span="10" style="marginLeft:20px">
              <a-form-model-item>
                <a-form-model-item label="Url File" prop="value">
                  <a-input v-model="URLCategoriesEdit.urlFile"/>
                </a-form-model-item>
              </a-form-model-item>
            </a-col>
          </a-row>
              ...
              <a-row>
                <a-col :span="24">
                  <v-table
                    ...
                    :columns="columns"
                    :table-data="URLCategoriesEdit.urlPatterns"
                    :height="180"
                    style="width: 100%"
                    isFrozen="true"
              ...
              <a-row>
                <a-col :span="24">
                  <v-table
                    ...
                    :table-data="URLCategoriesEdit.urlStrings"
                    :height="180"
                    style="width: 100%"
                    isFrozen="true"
...
import { urlCategoriesSelect, urlCategoriesEdit } from 'apis/urlCategories';

import Vue from 'vue';
export default {
  props: ['URLCategoriesEdit'],
  data() {
    return {
      loading: false,
      visible: false,
  ...
  methods: {
    showModalEdit() {
      this.visible = true;
      console.log(this.URLCategoriesEdit);
      // if (this.URLCategoriesEdit) {
      //   const params = this.URLCategoriesEdit;
      //   console.log(params);
      //   this.form.urlCategory = params;
      //   this.tableData = params.urlPatterns;
      //   this.tableDataSecond = params.urlStrings;
      // }
    },
    async handleOk() {
      ...
      this.form.urlCategory.urlPatterns = this.URLCategoriesEdit.urlPatterns;
      this.form.urlCategory.urlStrings = this.URLCategoriesEdit.urlStrings;
      const res = await urlCategoriesEdit(this.URLCategoriesEdit);
      console.log(res);
      this.loading = false;
    ...
    handleCancel() {
      ...
      this.URLCategoriesEdit.urlStrings = [{ reputation: '', stringValue: '' }];
      this.URLCategoriesEdit.urlPatterns = [
        { reputation: '', patternValue: '' }
      ];
    ...
    addOneline({ index, field, $event, selectVal }) {
      ...
      if (!field)
        return this.URLCategoriesEdit.urlPatterns.splice(index + 1, 0, {
          reputation: '',
          patternValue: ''
        });
      if ($event)
        return (this.URLCategoriesEdit.urlPatterns[index][field] =
          $event.target.value);
      if (selectVal)
        return (this.URLCategoriesEdit.urlPatterns[index][field] = selectVal);
    },
    addOnelineSecond({ index, field, $event, selectVal }) {
      if (!field)
        return this.URLCategoriesEdit.urlStrings.splice(index + 1, 0, {
          reputation: '',
          stringValue: ''
        });
      if ($event)
        return (this.URLCategoriesEdit.urlStrings[index][field] =
          $event.target.value);
      if (selectVal)
        return (this.URLCategoriesEdit.urlStrings[index][field] = selectVal);
