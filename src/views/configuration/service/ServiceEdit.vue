<template>
  <div>
    ...
    >
      ...
      <a-form-model :rules="rules" :model="editData" ref="ruleForm">
        <div class="title">
          <a-row>
            <a-col :span="20">
              <a-form-model-item label="Name" prop="name">
                <a-input size="small" v-model="editData.name"/>
              </a-form-model-item>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="24">
              <a-form-model-item label="Description">
                <a-input size="small" v-model="editData.description"/>
              </a-form-model-item>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="24">
              <a-form-model-item>
                <a-radio-group v-model="editData.isProtocol" @change="radio">
          ...
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="Protocol" prop="protocol">
                <a-select
                  :disabled="editData.isProtocol === 'true' ? false : true"
                  v-model="editData.protocol"
                  size="small"
                  @change="handleChange"
                >
            ...
            <a-col :span="12">
              <a-form-model-item label="Protocol Value">
                <a-input
                  :disabled="editData.isProtocol === 'true' ? true : false"
                  size="small"
                  v-model="editData.ProtocolValue"
                />
              </a-form-model-item>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="24">
              <a-form-model-item>
                <a-radio-group name="radioGroup" v-model="editData.isPort">
          ...
          <a-row>
            <a-col :span="7">
              <a-form-model-item label="Port" prop="Port">
                <a-input
                  :disabled="editData.isPort === 'true' ? false : true"
                  size="small"
            ...
            <a-col :span="7">
              <a-form-model-item label="Source Port" prop="SourcePort">
                <a-input
                  :disabled="editData.isPort === 'true' ? true : false"
                  size="small"
                  v-model="editData.SourcePort"
                />
              </a-form-model-item>
            </a-col>
            <a-col :span="7">
              <a-form-model-item label="Destination Port" prop="destinationPort">
                <a-input
                  :disabled="editData.isPort === 'true' ? true : false"
                  size="small"
                  v-model="editData.destinationPort"
                />
              </a-form-model-item>
            </a-col>
          </a-row>
...
<script>
import { ServiceEdit } from 'apis/service';
...
export default {
  ...
  methods: {
    ...
    handleOk() {
      ...
      if (this.editData.isProtocol === 'true') {
        rule.push('protocol');
      }
      const formBool = [];
    ...
    async createdService() {
      ...
      const res = await ServiceEdit(this.editData);
    ...
    handleCancel() {
      this.visible = false;
      // this.editData = {};
      // this.editData.isProtocol = 'true';
      // this.editData.isPort = 'true';
      // this.clear();
    ...
    handleChange(e) {
      ...
      console.log(e);
      console.log(this.editData.protocol);
    },
    clear() {},
    callback(key) {
      console.log(key);
