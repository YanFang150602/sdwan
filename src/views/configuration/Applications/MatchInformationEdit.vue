      ...
      <a-form-model :model="form.address" ref="ruleForm">
            ...
            <a-col :span="24">
              <a-form-model-item>
                <a-form-model-item label="Name">
                  <a-input v-model="MatchInformationEdit.name" />
                </a-form-model-item>
              </a-form-model-item>
            </a-col>
          </a-row>
        ...
        <div class="SourcePort">
          <a-form-model-item class="Source">
            <a-checkbox name="type" v-model="form.SourcePort"
              >Source Port</a-checkbox
            >
          </a-form-model-item>
          <a-form-model-item>
          ...
          <a-row>
            ...
            <a-col :span="8">
              <a-form-model-item label="Low">
                <a-input
                  v-model="form.SourceLow"
                  :disabled="isDisabled.includes('Low')"
                />
              </a-form-model-item>
            </a-col>
            <a-col :span="8">
              <a-form-model-item label="Highs">
                <a-input
                  v-model="form.SourceHighs"
                  :disabled="isDisabled.includes('Highs')"
                />
              </a-form-model-item>
            </a-col>
          </a-row>
        ...
        <div class="DestinationPort">
          <a-form-model-item class="Destination">
            <a-checkbox name="type1" v-model="form.DestinationPort"
              >Destination Port</a-checkbox
            >
          </a-form-model-item>
          <a-form-model-item>
...
export default {
  ...
  computed: {
    isDisabled() {
      ...
      const res = [];
      if (this.form.resource == 'value') res.push('Source Port Value');
      if (this.form.resource == 'Range') res.push('Low', 'Highs');
  ...
  watch: {
    ...
    MatchInformationEdit(newVal) {
      console.log(newVal, 'MatchInformationEdit');
    }
  },
  methods: {
    showModalEdit() {
