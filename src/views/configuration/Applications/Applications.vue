<template>
  <div class="devices">
    ...
    <!-- 查看弹框 -->
    <ApplicationEdit ref="ApplicationEditRef" :ApplicationEdit="checkInformation"></ApplicationEdit>
    <!-- 删除的弹框 -->
    <ApplicationDelete ref="ApplicationDeleteRef" :ApplicationDelete="dele"></ApplicationDelete>
  </div>
</template>
