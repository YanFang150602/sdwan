                ...
                <a-col :span="24">
                  <a-form-model-item>
                    <a-form-model-item label="Name">
                      <a-input v-model="EditRuleToline.name"/>
                    </a-form-model-item>
                  </a-form-model-item>
                </a-col>
              </a-row>
                ...
                <a-col :span="24">
                  <a-form-model-item>
                    <a-form-model-item label="Description">
                      <a-input v-model="EditRuleToline.description"/>
                    </a-form-model-item>
                  </a-form-model-item>
                </a-col>
              </a-row>
            ...
            <a-row type="flex" justify="space-between" align="top">
                ...
                <p class="height-100">
                  <a-form-model-item style="float:left">
                    <AddModle
                      ...
                      style="width:405px;margin-left:15px"
                      :listdate="allListpredefinedApps"
                      @subdata="(val)=>subit(val,'PredefinedApplications')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
              <a-col :span="8">
                <p class="height-50">
                  <a-form-model-item style="float:right">
                    <AddModle
                      :title="CustomApplications"
                      style="width:405px;margin-left:15px"
                      :listdate="predeList"
                      @subdata="(val) => currentEdit.customApplications = val"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
            ...
            <a-row type="flex" justify="space-between" align="top">
              <a-col :span="8">
                <p class="height-100">
                  <a-form-model-item style="float:left">
                    <AddModle
                      :title="PredefinedApplicationfilters"
                      :listdate="allListpredefinedFilters"
                      style="width:405px;margin-left:15px"
                      @subdata="(val)=>subit(val,'PredefinedApplicationfilters')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
              <a-col :span="8">
                <p class="height-50">
                  <a-form-model-item style="float:right">
                    <AddModle
                      :title="CustomApplicationFilters"
                      style="width:405px;margin-left:15px"
                      :listdate="cusappList"
                      @subdata="(val)=>subit(val,'CustomApplicationFilters')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
            ...
            <a-row type="flex" justify="space-between" align="top">
              <a-col :span="4">
                <p class="height-100">
                  <a-form-model-item style="float:left">
                    <AddModle
                      :title="PredefinedApplicationGroups"
                      style="width:405px;margin-left:15px"
                      :listdate="allListappGroups"
                      @subdata="(val)=>subit(val,'PredefinedApplicationGroups')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
            ...
            <a-row type="flex" justify="space-between" align="top">
              <a-col :span="4">
                <p class="height-100">
                  <a-form-model-item style="float:left">
                    <AddModle
                      :title="PredefinedURLCategories"
                      style="width:405px;margin-left:15px"
                      :listdate="allListcategories "
                      @subdata="(val)=>subit(val,'PredefinedURLCategories')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
              <a-col :span="4">
                <p class="height-50">
                  <a-form-model-item style="float:right">
                    <AddModle
                      :title="CustomURLCategories"
                      style="width:405px;margin-left:15px"
                      :listdate="CustomerList"
                      @subdata="(val)=>subit(val,'CustomURLCategories')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
            ...
            <a-row type="flex" justify="space-between" align="top">
              <a-col :span="4">
                <p class="height-100">
                  <a-form-model-item style="float:left">
                    <AddModle
                      :title="PredefinedServices"
                      style="width:405px;margin-left:15px"
                      :listdate="allListservices"
                      @subdata="(val)=>subit(val,'PredefinedServices')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
              <a-col :span="4">
                <p class="height-50">
                  <a-form-model-item style="float:right">
                    <AddModle
                      :title="CustomServices"
                      style="width:405px;margin-left:15px"
                      :listdate="cusSerList"
                      @subdata="(val)=>subit(val,'CustomServices')"
                    />
                  </a-form-model-item>
                </p>
              </a-col>
...
import AddModle from 'components/Traffic';
import AddModleDouble from 'components/TrafficDouble';
export default {
  props: ['EditRuleTo', 'EditRuleToline'],
  mixins: [tip],
  created() {},
  components: {
    AddModle,
